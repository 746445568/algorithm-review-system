# agent.md instructions for C:\dev\algorithm-review-system
...
- If the index is stale after edits, wait briefly or re-check status before relying on symbol results.
